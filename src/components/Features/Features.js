...
export default class Features extends React.Component {
  ...
  render() {
    return (
      <div className="py-4" id="featurePage">
          ...
          <div className="row align-items-center">
            <div className="featureItem col-6">
              ...
              <p className="w-75 text-justify">
                The chatbot excels in the interaction with the user as, within
                the first conversation only, the NeyX chatbot develops a
                friendly relationship with the customer. The creative efforts
                are inbuilt in the bot to sustain an ongoing bargaining deal.
              </p>
            </div>
            <div className="featureItem col-6">
              <div className="d-flex flex-column">
              ...
              <p className="w-75 text-justify">
                The NeyX bot is designed such that the price negotiation is set
                up by the owner of the website to offer the best discount based
                on consumer behaviour, market, demand which builds a strong
            ...
            <div className="featureItem col-6">
              ...
              <p className="w-75 text-justify">
                ...
                your website. The bot can deal with lakhs of customers
                altogether
              </p>
            </div>
            <div className="featureItem col-6">
